...
insert into ROLUSUARIO (ID_ROL,NOMBRE) values(6,'Organizador campaña');
...
insert into RESERVASERVICIO (ID_SERVICIO, NUMDOC, ID_IPS, FECHAHORA) values(3,1,2, TO_DATE('16/01/2018', 'DD/MM/YYYY'));
...
insert into PRESTACIONSERVICIO (NUMDOC, ID_SERVICIO, ID_IPS, FECHAHORA, ID_RECEPCIONISTA) values(1,3,2,TO_DATE('16/01/2018', 'DD/MM/YYYY'),124);
